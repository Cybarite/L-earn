...
load-json: use [
	tree branch here val is-flat emit new-child to-parent neaten
	...
	word: use [word1 word+ special escapes escape wordify][
		...
		[#"^"" copy val some [word1 | special] #"^"" (val: wordify val)]
	]
...
to-json: use [
	...
	to-token: use [special escapes mark][
		special: charset "&'+-.0123456789nst^^_"
		escapes: [#"t" "^-" #"n" "^/" #"_" " "]
